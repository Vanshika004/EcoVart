...
"[project]/pages/shop.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Shop() {
    ...
    const [sort, setSort] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])("popular");
    ...
    const categories = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Shop.useMemo[categories]": ()=>[
                "All",
                ...Array.from(new Set(__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$products$2e$js__$5b$client$5d$__$28$ecmascript$29$__["products"].map({
                    "Shop.useMemo[categories]": (p)=>p.category
                }["Shop.useMemo[categories]"]))).filter(Boolean)
            ]
    }["Shop.useMemo[categories]"], []);
    const filtered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Shop.useMemo[filtered]": ()=>{
            let list = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$products$2e$js__$5b$client$5d$__$28$ecmascript$29$__["products"].slice();
            if (category !== "All") list = list.filter({
                "Shop.useMemo[filtered]": (p)=>p.category === category
            }["Shop.useMemo[filtered]"]);
            if (search) list = list.filter({
                "Shop.useMemo[filtered]": (p)=>p.name.toLowerCase().includes(search.toLowerCase())
            }["Shop.useMemo[filtered]"]);
            if (sort === "price_asc") list.sort({
                "Shop.useMemo[filtered]": (a, b)=>a.price - b.price
            }["Shop.useMemo[filtered]"]);
            if (sort === "price_desc") list.sort({
                "Shop.useMemo[filtered]": (a, b)=>b.price - a.price
            }["Shop.useMemo[filtered]"]);
            return list;
        }
    }["Shop.useMemo[filtered]"], [
                ...
                children: [
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: categories.map((c)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: filtered.map((p)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ProductCard$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"], {
                                    product: p
                                }, p.id, false, {
                                    fileName: "[project]/pages/shop.js",
                                    lineNumber: 79,
...
_s(Shop, "hdqvJ1xvN4feuakA1Bdez05yFhg=");
_c = Shop;
var _c;
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/pages/shop.js [client] (ecmascript)\" } [client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const PAGE_PATH = "/shop";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/pages/shop.js [client] (ecmascript)");
    }
]);
...
__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/pages/shop.js [client] (ecmascript)\" } [client] (ecmascript)");
}),
]);

//# sourceMappingURL=%5Broot-of-the-server%5D__6af11ed9._.js.map